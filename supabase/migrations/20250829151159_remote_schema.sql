...
CREATE TABLE IF NOT EXISTS "public"."consumerShop12m" (
    "id" bigint NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "consumer" bigint,
    "shop" bigint,
...
ALTER TABLE "public"."consumerShop12m" OWNER TO "postgres";


COMMENT ON TABLE "public"."consumerShop12m" IS '12month performance for consumers by shop';



COMMENT ON COLUMN "public"."consumerShop12m"."grossSales" IS '12 month gross sales';



COMMENT ON COLUMN "public"."consumerShop12m"."shopsShopped" IS 'number of shops shopped at during 12M period';



ALTER TABLE "public"."consumerShop12m" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."consumerShop12m_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."consumerShop12m"
    ADD CONSTRAINT "consumerShop12m_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."consumerShop12m"
    ADD CONSTRAINT "consumerShop12m_consumer_fkey" FOREIGN KEY ("consumer") REFERENCES "public"."consumers"("id");



ALTER TABLE ONLY "public"."consumerShop12m"
    ADD CONSTRAINT "consumerShop12m_shop_fkey" FOREIGN KEY ("shop") REFERENCES "public"."shops"("id");
...
ALTER TABLE "public"."consumerShop12m" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON TABLE "public"."consumerShop12m" TO "anon";
GRANT ALL ON TABLE "public"."consumerShop12m" TO "authenticated";
GRANT ALL ON TABLE "public"."consumerShop12m" TO "service_role";



GRANT ALL ON SEQUENCE "public"."consumerShop12m_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."consumerShop12m_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."consumerShop12m_id_seq" TO "service_role";
