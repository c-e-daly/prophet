...
import { RemixServer, useLoaderData, Meta, Links, Outlet, ScrollRestoration, Scripts, LiveReload, useRouteError, useActionData, Form, Link, useRouteLoaderData } from "@remix-run/react";
import { createReadableStreamFromReadable, json, redirect } from "@remix-run/node";
import { isbot } from "isbot";
import "@shopify/shopify-app-remix/adapters/node";
import { Session, shopifyApp, AppDistribution, ApiVersion, boundary, LoginErrorType } from "@shopify/shopify-app-remix/server";
import { createClient as createClient$1 } from "@supabase/supabase-js";
import { AppProvider } from "@shopify/shopify-app-remix/react";
import crypto from "crypto";
import React, { useState, useRef, useEffect } from "react";
import { AppProvider as AppProvider$1, Page, Card, FormLayout, Text, TextField, Button, Layout, BlockStack, InlineStack, Box, InlineGrid, Banner } from "@shopify/polaris";
import { NavMenu } from "@shopify/app-bridge-react";
import Highcharts from "highcharts/highmaps.js";
import Highcharts$1 from "highcharts/highstock.js";
...
const supabaseSessionStorage = {
  async storeSession(session) {
    ...
    await supabase.from(TABLE_NAME).upsert({ id, session: JSON.stringify(rest) }, { onConflict: "id" });
    return true;
  },
  async loadSession(id) {
    const { data, error } = await supabase.from(TABLE_NAME).select("session").eq("id", id).single();
...
async function storeShopCredentials(shop, accessToken, scopes) {
  var _a;
  console.log("Environment check:", {
    hasSupabaseUrl: !!process.env.SUPABASE_URL,
    hasServiceKey: !!process.env.SUPABASE_SERVICE_ROLE_KEY,
    serviceKeyPrefix: ((_a = process.env.SUPABASE_SERVICE_ROLE_KEY) == null ? void 0 : _a.substring(0, 20)) + "..."
  });
  const supabase2 = createClient$1(
    process.env.SUPABASE_URL,
    process.env.SUPABASE_SERVICE_ROLE_KEY
  );
  ...
  const { error: authError } = await supabase2.from("shopauth").upsert({
    id: shop,
    // Use shop domain as ID
    shop: shopData.id,
    // Reference to shops table
    shop_id: shopInfo.id,
    // Shopify's shop ID for easy joining
    shop_name: shopInfo.name,
    access_token: accessToken,
    // NEW TOKEN - critical to update!
...
function isValidShopDomain$1(shop) {
...
const loader$6 = async ({ request }) => {
  ...
  const authUrl = `https://${shop}/admin/oauth/authorize?client_id=${CLIENT_ID}&scope=${encodeURIComponent(SCOPES)}&redirect_uri=${encodeURIComponent(CALLBACK_URL)}&state=${state}`;
...
async function loader$4({ request }) {
  ...
  const supabase2 = createClient();
  const { data: shopauth, error: authError } = await supabase2.from("shopauth").select("access_token, shop_name, shop_id").eq("id", shop).single();
  console.log("Auth query details:", {
    queryingFor: shop,
    hasAuth: !!shopauth,
    hasToken: !!(shopauth == null ? void 0 : shopauth.access_token),
    authError,
    shopAuthData: shopauth ? { hasToken: !!shopauth.access_token, shopName: shopauth.shop_name } : null,
    justInstalled: !!installed,
    shopid: !!(shopauth == null ? void 0 : shopauth.shop_id)
  });
  if ((shopauth == null ? void 0 : shopauth.access_token) || installed) {
...
async function loader$3({ request }) {
  ...
  const shop = url.searchParams.get("shop");
  const host = url.searchParams.get("host");
  const apiKey2 = process.env.SHOPIFY_CLIENT_ID;
  if (!shop) {
    throw new Response("Missing shop parameter", { status: 400 });
  }
  const supabase2 = createClient();
  const { data: shopauth } = await supabase2.from("shopauth").select("shop_name, access_token").eq("id", shop).single();
  return {
    shop,
    host,
    url: request.url,
    shopName: (shopauth == null ? void 0 : shopauth.shop_name) || shop,
    hasToken: !!(shopauth == null ? void 0 : shopauth.access_token),
    apiKey: apiKey2
  };
}
...
const mapDataUS = {
  ...
  copyrightUrl,
  crs,
  "hc-transform": { "default": { "crs": "+proj=lcc +lat_1=33 +lat_2=45 +lat_0=39 +lon_0=-96 +x_0=0 +y_0=0 +datum=NAD83 +units=m +no_defs", "scale": 151481324748e-15, "jsonres": 15.5, "jsonmarginX": -999, "jsonmarginY": 9851, "xoffset": -236135609818e-5, "yoffset": 139899677886e-5 }, "us-all-hawaii": { "xpan": 190, "ypan": 417, "hitZone": { "type": "Polygon", "coordinates": [[[1747, 3920], [3651, 2950], [3651, -999], [1747, -999], [1747, 3920]]] }, "crs": "+proj=aea +lat_1=8 +lat_2=18 +lat_0=13 +lon_0=-157 +x_0=0 +y_0=0 +datum=NAD83 +units=m +no_defs", "scale": 123090941806e-15, "jsonres": 15.5, "jsonmarginX": -999, "jsonmarginY": 9851, "xoffset": -338610.47557, "yoffset": 102275431736e-5 }, "us-all-alaska": { "rotation": -0.0174532925199, "xpan": 5, "ypan": 357, "hitZone": { "type": "Polygon", "coordinates": [[[-999, 5188], [-707, 5188], [1747, 3920], [1747, -999], [-999, -999], [-999, 5188]]] }, "crs": "+proj=tmerc +lat_0=54 +lon_0=-142 +k=0.9999 +x_0=500000 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs", "scale": 584397059179e-16, "jsonres": 15.5, "jsonmarginX": -999, "jsonmarginY": 9851, "xoffset": -156615400853e-5, "yoffset": 199267114918e-5 } },
  features
};
async function getConsumerGeolocation(shopDomain) {
  const supabase2 = createClient();
  const { data: auth, error: authError } = await supabase2.from("shopauth").select("shop_id").eq("id", shopDomain).single();
  if (authError || !(auth == null ? void 0 : auth.shop_id)) {
    console.error("[dashboard] shopauth lookup failed", { shopDomain, authError, auth });
    throw new Error("Unable to find internal shop_id");
  }
  const rawShopId = auth.shop_id;
  const pShopId = Number(rawShopId);
  ...
  const { data, error } = await supabase2.rpc("consumer_geolocation", {
    p_shop_id: pShopId
  });
  if (error) {
  ...
  console.log("[geolocation] RPC ok. typeof data:", typeof data);
  return data ?? {};
}
...
const getSCFCoordinates = (scf) => {
  const scfMap = {
    "100": { lat: 40.7128, lon: -74.006 },
    // NYC area
    "200": { lat: 38.9072, lon: -77.0369 },
    // DC area  
    "300": { lat: 33.749, lon: -84.388 },
    // Atlanta area
    "400": { lat: 36.1627, lon: -86.7816 },
    // Nashville area
    "600": { lat: 41.8781, lon: -87.6298 },
    // Chicago area
    "700": { lat: 32.7767, lon: -96.797 },
    // Dallas area
    "800": { lat: 39.7392, lon: -104.9903 },
    // Denver area
    "900": { lat: 34.0522, lon: -118.2437 }
    // LA area
    // Add more mappings as needed
  };
  return scfMap[scf] || { lat: 39.8283, lon: -98.5795 };
};
const getSpendColor = (spend) => {
  if (spend >= 1e5) return "#22c55e";
  if (spend >= 5e4) return "#3b82f6";
  if (spend >= 25e3) return "#f59e0b";
  if (spend >= 1e4) return "#ef4444";
  return "#6b7280";
};
const getSpendCategory = (spend) => {
  if (spend >= 1e5) return "Very High ($100K+)";
  if (spend >= 5e4) return "High ($50K-$100K)";
  if (spend >= 25e3) return "Medium ($25K-$50K)";
  if (spend >= 1e4) return "Low ($10K-$25K)";
  return "Very Low (<$10K)";
};
function Geolocation() {
  ...
  useEffect(() => {
    if (!chartRef.current || !(summary == null ? void 0 : summary.scf_data)) return;
    const mapData = summary.scf_data.map((scfData2) => {
      const coords = getSCFCoordinates(scfData2.scf);
      return {
        name: `SCF ${scfData2.scf}`,
        lat: coords.lat,
        lon: coords.lon,
        z: scfData2.current_12m.spend,
        color: getSpendColor(scfData2.current_12m.spend),
        custom: {
          scf: scfData2.scf,
          category: getSpendCategory(scfData2.current_12m.spend),
          consumers: scfData2.current_12m.consumers,
          orders: scfData2.current_12m.orders,
          units: scfData2.current_12m.units,
          spendChange: scfData2.percent_change.spend,
          consumerChange: scfData2.percent_change.consumers
        }
      };
    });
    Highcharts.mapChart({
      ...
      series: [
        ...
        },
        {
          ...
          tooltip: {
            pointFormat: "<b>SCF {point.custom.scf}</b><br/>Total Spend: <b>${point.z:,.0f}</b><br/>Customers: <b>{point.custom.consumers}</b><br/>Orders: <b>{point.custom.orders}</b><br/>Units: <b>{point.custom.units}</b><br/>Category: <b>{point.custom.category}</b><br/>{#if point.custom.spendChange}Spend Change: <b>{#if (gt point.custom.spendChange 0)}+{/if}{point.custom.spendChange}%</b><br/>{/if}{#if point.custom.consumerChange}Customer Change: <b>{#if (gt point.custom.consumerChange 0)}+{/if}{point.custom.consumerChange}%</b>{/if}"
          }
        }
      ],
  ...
  const scfData = (summary == null ? void 0 : summary.scf_data) || [];
  const veryHigh = scfData.filter((d) => d.current_12m.spend >= 1e5).length;
  const high = scfData.filter((d) => d.current_12m.spend >= 5e4 && d.current_12m.spend < 1e5).length;
  const medium = scfData.filter((d) => d.current_12m.spend >= 25e3 && d.current_12m.spend < 5e4).length;
...
function Portfolios() {
  return /* @__PURE__ */ jsx(Page, { children: /* @__PURE__ */ jsx(Outlet, {}) });
}
...
async function getDashboardSummary(shopDomain) {
  const supabase2 = createClient();
  const { data: auth, error: authError } = await supabase2.from("shopauth").select("shop_id").eq("id", shopDomain).single();
  if (authError || !(auth == null ? void 0 : auth.shop_id)) {
    console.error("[dashboard] shopauth lookup failed", { shopDomain, authError, auth });
  ...
  const { data, error } = await supabase2.rpc("dashboard_sales_summary", {
    p_shop_id: pShopId
  });
  if (error) {
  ...
  console.log("[dashboard] RPC ok. typeof data:", typeof data);
  return data ?? {};
}
...
function NorTrend({
  ...
  const [mode2, setMode] = React.useState("weeks");
  const [mounted, setMounted] = React.useState(false);
  React.useEffect(() => setMounted(true), []);
  const fmtUSD = (n) => (n ?? 0).toLocaleString(void 0, { style: "currency", currency: "USD", maximumFractionDigits: 0 });
  const weekSeries = [
    {
      type: "line",
      name: "NOR (CY)",
      data: (weeks ?? []).map((p) => [Date.parse(p.date + "T00:00:00Z"), Number(p.cy) || 0]),
      tooltip: { valueDecimals: 0 }
    }
  ];
  const monthCategories = (months ?? []).map(
    (m) => new Date(m.date).toLocaleDateString(void 0, { month: "short" })
  );
...
const fmtCurrency = (n) => (n ?? 0).toLocaleString(void 0, { style: "currency", currency: "USD", maximumFractionDigits: 0 });
const fmtNumber = (n) => (n ?? 0).toLocaleString();
const fmtAOV = (n) => (n ?? 0).toLocaleString(void 0, { style: "currency", currency: "USD", maximumFractionDigits: 2 });
const pctChange = (cy, py) => {
  if (!py) return 0;
  return (cy - py) / py * 100;
};
...
function PortfolioCard({
  ...
  const rows = [
    {
      label: "Orders",
      cy: fmtNumber((cy == null ? void 0 : cy.order_count) || 0),
      py: fmtNumber((py == null ? void 0 : py.order_count) || 0),
      delta: pctChange((cy == null ? void 0 : cy.order_count) || 0, (py == null ? void 0 : py.order_count) || 0)
    },
    {
      label: "Gross Sales",
      cy: fmtCurrency((cy == null ? void 0 : cy.gross_sales) || 0),
      py: fmtCurrency((py == null ? void 0 : py.gross_sales) || 0),
      delta: pctChange((cy == null ? void 0 : cy.gross_sales) || 0, (py == null ? void 0 : py.gross_sales) || 0)
    },
    {
      label: "NOR Sales",
      cy: fmtCurrency((cy == null ? void 0 : cy.nor_sales) || 0),
      py: fmtCurrency((py == null ? void 0 : py.nor_sales) || 0),
      delta: pctChange((cy == null ? void 0 : cy.nor_sales) || 0, (py == null ? void 0 : py.nor_sales) || 0)
    },
    {
      label: "Consumers",
      cy: fmtNumber((cy == null ? void 0 : cy.consumers) || 0),
      py: fmtNumber((py == null ? void 0 : py.consumers) || 0),
      delta: pctChange((cy == null ? void 0 : cy.consumers) || 0, (py == null ? void 0 : py.consumers) || 0)
    },
    {
      label: "AOV",
      cy: fmtAOV((cy == null ? void 0 : cy.aov) || 0),
      py: fmtAOV((py == null ? void 0 : py.aov) || 0),
...
const serverManifest = { "entry": { "module": "/assets/entry.client-ChuLWD4P.js", "imports": ["/assets/jsx-runtime-0DLF9kdB.js", "/assets/index-D8WRu5oy.js", "/assets/index-CZB_Ibz4.js", "/assets/components-B2-GOgf1.js"], "css": [] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/root-B-qbnNC1.js", "imports": ["/assets/jsx-runtime-0DLF9kdB.js", "/assets/index-D8WRu5oy.js", "/assets/index-CZB_Ibz4.js", "/assets/components-B2-GOgf1.js", "/assets/AppProxyProvider-Dgg2a_4I.js", "/assets/AppProvider-BqYvICWC.js", "/assets/context-DyOSZSIO.js"], "css": ["/assets/styles-BeiPL2RV.css"] }, "routes/webhooks.app.scopes_update": { "id": "routes/webhooks.app.scopes_update", "parentId": "root", "path": "webhooks/app/scopes_update", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/webhooks.app.scopes_update-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/webhooks.app.uninstalled": { "id": "routes/webhooks.app.uninstalled", "parentId": "root", "path": "webhooks/app/uninstalled", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/webhooks.app.uninstalled-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/auth.callback": { "id": "routes/auth.callback", "parentId": "root", "path": "auth/callback", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/auth.callback-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/auth._index": { "id": "routes/auth._index", "parentId": "root", "path": "auth", "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/auth._index-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/auth.login": { "id": "routes/auth.login", "parentId": "root", "path": "auth/login", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/auth.login-f6DsIdkC.js", "imports": ["/assets/jsx-runtime-0DLF9kdB.js", "/assets/index-D8WRu5oy.js", "/assets/components-B2-GOgf1.js", "/assets/AppProvider-BqYvICWC.js", "/assets/Page-CsEogIui.js", "/assets/Card-B868ABYJ.js", "/assets/index-CZB_Ibz4.js", "/assets/context-DyOSZSIO.js", "/assets/within-content-context-DIv_5tIU.js"], "css": ["/assets/styles-BeiPL2RV.css"] }, "routes/_index": { "id": "routes/_index", "parentId": "root", "path": void 0, "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/_index-CO-SioIX.js", "imports": ["/assets/jsx-runtime-0DLF9kdB.js"], "css": [] }, "routes/app": { "id": "routes/app", "parentId": "root", "path": "app", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/app-DDDLANbw.js", "imports": ["/assets/jsx-runtime-0DLF9kdB.js", "/assets/AppProxyProvider-Dgg2a_4I.js", "/assets/index-D8WRu5oy.js", "/assets/components-B2-GOgf1.js", "/assets/index-CZB_Ibz4.js", "/assets/AppProvider-BqYvICWC.js", "/assets/context-DyOSZSIO.js"], "css": [] }, "routes/app.geolocation": { "id": "routes/app.geolocation", "parentId": "routes/app", "path": "geolocation", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/app.geolocation-DOeGBkSz.js", "imports": ["/assets/jsx-runtime-0DLF9kdB.js", "/assets/index-D8WRu5oy.js", "/assets/components-B2-GOgf1.js", "/assets/Page-CsEogIui.js", "/assets/Layout-Cj-Ff9d7.js", "/assets/Card-B868ABYJ.js", "/assets/index-CZB_Ibz4.js", "/assets/context-DyOSZSIO.js", "/assets/within-content-context-DIv_5tIU.js"], "css": [] }, "routes/app.portfolios": { "id": "routes/app.portfolios", "parentId": "routes/app", "path": "portfolios", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/app.portfolios-DsK0Twnn.js", "imports": ["/assets/jsx-runtime-0DLF9kdB.js", "/assets/Page-CsEogIui.js", "/assets/index-CZB_Ibz4.js", "/assets/index-D8WRu5oy.js", "/assets/context-DyOSZSIO.js"], "css": [] }, "routes/app.portfolios.reactivated": { "id": "routes/app.portfolios.reactivated", "parentId": "routes/app.portfolios", "path": "reactivated", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/app.portfolios.reactivated-DK1Qw5at.js", "imports": ["/assets/jsx-runtime-0DLF9kdB.js", "/assets/Page-CsEogIui.js", "/assets/Layout-Cj-Ff9d7.js", "/assets/Card-B868ABYJ.js", "/assets/index-D8WRu5oy.js", "/assets/context-DyOSZSIO.js", "/assets/within-content-context-DIv_5tIU.js"], "css": [] }, "routes/app.portfolios.topquintile": { "id": "routes/app.portfolios.topquintile", "parentId": "routes/app.portfolios", "path": "topquintile", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/app.portfolios.topquintile-B76cvXyM.js", "imports": ["/assets/jsx-runtime-0DLF9kdB.js", "/assets/Page-CsEogIui.js", "/assets/Layout-Cj-Ff9d7.js", "/assets/Card-B868ABYJ.js", "/assets/index-D8WRu5oy.js", "/assets/context-DyOSZSIO.js", "/assets/within-content-context-DIv_5tIU.js"], "css": [] }, "routes/app.portfolios.declining": { "id": "routes/app.portfolios.declining", "parentId": "routes/app.portfolios", "path": "declining", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/app.portfolios.declining-61zT-onn.js", "imports": ["/assets/jsx-runtime-0DLF9kdB.js", "/assets/index-D8WRu5oy.js", "/assets/components-B2-GOgf1.js", "/assets/Page-CsEogIui.js", "/assets/Layout-Cj-Ff9d7.js", "/assets/Card-B868ABYJ.js", "/assets/index-CZB_Ibz4.js", "/assets/context-DyOSZSIO.js", "/assets/within-content-context-DIv_5tIU.js"], "css": [] }, "routes/app.portfolios.defected": { "id": "routes/app.portfolios.defected", "parentId": "routes/app.portfolios", "path": "defected", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/app.portfolios.defected-mS6x5_Bo.js", "imports": ["/assets/jsx-runtime-0DLF9kdB.js", "/assets/Page-CsEogIui.js", "/assets/Layout-Cj-Ff9d7.js", "/assets/Card-B868ABYJ.js", "/assets/index-D8WRu5oy.js", "/assets/context-DyOSZSIO.js", "/assets/within-content-context-DIv_5tIU.js"], "css": [] }, "routes/app.portfolios._index": { "id": "routes/app.portfolios._index", "parentId": "routes/app.portfolios", "path": void 0, "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/app.portfolios._index-cipkW6aL.js", "imports": ["/assets/jsx-runtime-0DLF9kdB.js", "/assets/Page-CsEogIui.js", "/assets/Layout-Cj-Ff9d7.js", "/assets/Card-B868ABYJ.js", "/assets/index-D8WRu5oy.js", "/assets/context-DyOSZSIO.js", "/assets/within-content-context-DIv_5tIU.js"], "css": [] }, "routes/app.portfolios.growth": { "id": "routes/app.portfolios.growth", "parentId": "routes/app.portfolios", "path": "growth", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/app.portfolios.growth-Bq-WyqMB.js", "imports": ["/assets/jsx-runtime-0DLF9kdB.js", "/assets/Page-CsEogIui.js", "/assets/Layout-Cj-Ff9d7.js", "/assets/Card-B868ABYJ.js", "/assets/index-D8WRu5oy.js", "/assets/context-DyOSZSIO.js", "/assets/within-content-context-DIv_5tIU.js"], "css": [] }, "routes/app.portfolios.stable": { "id": "routes/app.portfolios.stable", "parentId": "routes/app.portfolios", "path": "stable", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/app.portfolios.stable-BuVqS_Mj.js", "imports": ["/assets/jsx-runtime-0DLF9kdB.js", "/assets/Page-CsEogIui.js", "/assets/Layout-Cj-Ff9d7.js", "/assets/Card-B868ABYJ.js", "/assets/index-D8WRu5oy.js", "/assets/context-DyOSZSIO.js", "/assets/within-content-context-DIv_5tIU.js"], "css": [] }, "routes/app.portfolios.new": { "id": "routes/app.portfolios.new", "parentId": "routes/app.portfolios", "path": "new", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/app.portfolios.new-BDbTK_yL.js", "imports": ["/assets/jsx-runtime-0DLF9kdB.js", "/assets/Page-CsEogIui.js", "/assets/Layout-Cj-Ff9d7.js", "/assets/Card-B868ABYJ.js", "/assets/index-D8WRu5oy.js", "/assets/context-DyOSZSIO.js", "/assets/within-content-context-DIv_5tIU.js"], "css": [] }, "routes/app.dashboard": { "id": "routes/app.dashboard", "parentId": "routes/app", "path": "dashboard", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/app.dashboard-DtPgfhy7.js", "imports": ["/assets/jsx-runtime-0DLF9kdB.js", "/assets/components-B2-GOgf1.js", "/assets/Page-CsEogIui.js", "/assets/Layout-Cj-Ff9d7.js", "/assets/index-D8WRu5oy.js", "/assets/Card-B868ABYJ.js", "/assets/index-CZB_Ibz4.js", "/assets/context-DyOSZSIO.js", "/assets/within-content-context-DIv_5tIU.js"], "css": [] }, "routes/app._index": { "id": "routes/app._index", "parentId": "routes/app", "path": void 0, "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/app._index-toM3khyV.js", "imports": ["/assets/jsx-runtime-0DLF9kdB.js", "/assets/components-B2-GOgf1.js", "/assets/Page-CsEogIui.js", "/assets/index-D8WRu5oy.js", "/assets/within-content-context-DIv_5tIU.js", "/assets/context-DyOSZSIO.js", "/assets/index-CZB_Ibz4.js"], "css": [] } }, "url": "/assets/manifest-f47599eb.js", "version": "f47599eb" };
...
const routes = {
  ...
  "routes/app.geolocation": {
    id: "routes/app.geolocation",
    parentId: "routes/app",
    path: "geolocation",
    index: void 0,
    caseSensitive: void 0,
  ...
  "routes/app.portfolios": {
    id: "routes/app.portfolios",
    parentId: "routes/app",
    path: "portfolios",
    index: void 0,
    caseSensitive: void 0,
  ...
  "routes/app.portfolios.reactivated": {
    id: "routes/app.portfolios.reactivated",
    parentId: "routes/app.portfolios",
    path: "reactivated",
    index: void 0,
    caseSensitive: void 0,
    module: route10
  },
  "routes/app.portfolios.topquintile": {
    id: "routes/app.portfolios.topquintile",
    parentId: "routes/app.portfolios",
    path: "topquintile",
    index: void 0,
    caseSensitive: void 0,
  ...
  "routes/app.portfolios.declining": {
    id: "routes/app.portfolios.declining",
    parentId: "routes/app.portfolios",
    path: "declining",
    index: void 0,
    caseSensitive: void 0,
  ...
  "routes/app.portfolios.defected": {
    id: "routes/app.portfolios.defected",
    parentId: "routes/app.portfolios",
    path: "defected",
    index: void 0,
    caseSensitive: void 0,
  ...
  "routes/app.portfolios._index": {
    id: "routes/app.portfolios._index",
    parentId: "routes/app.portfolios",
    path: void 0,
    index: true,
    caseSensitive: void 0,
  ...
  "routes/app.portfolios.growth": {
    id: "routes/app.portfolios.growth",
    parentId: "routes/app.portfolios",
    path: "growth",
    index: void 0,
    caseSensitive: void 0,
  ...
  "routes/app.portfolios.stable": {
    id: "routes/app.portfolios.stable",
    parentId: "routes/app.portfolios",
    path: "stable",
    index: void 0,
    caseSensitive: void 0,
  ...
  "routes/app.portfolios.new": {
    id: "routes/app.portfolios.new",
    parentId: "routes/app.portfolios",
    path: "new",
    index: void 0,
    caseSensitive: void 0,
